...
We figure out one particular trajectory here, but we observe similar results on other draws. We see that the best value for $\alpha$ is $0.46$ here.
...
The final regret value is here around 10 whereas it was around 200 for linUCB with the best fitted $\alpha$.

The best arm was effectively the most pulled and was pulled 978 times, similar to 944 for linUCB. But, for a given sample, OFUL better detects which arm is the best among the pool.
%
%
\newpage
